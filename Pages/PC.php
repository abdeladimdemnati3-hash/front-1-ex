...
<body>
  ...
  <main class="container">
    <div class="custom-card">
      <div class="card-img">
        <img src="../img/M100A-–-AMD-RYZEN-5-3500X-RTX-5050-8Go-Setup-Game.webp" alt="PC Gamer M100A">
      </div>
      <div class="info">
        <h4>BuyEase</h4>
        <h3>M100A – AMD RYZEN 5 3500X-RTX 5050 8Go</h3>
        <p>
          Le Pc Gamer 3500X RTX 5050 Maroc incarne le parfait équilibre entre puissance,
          vitesse et prix accessible. Pensé pour les passionnés de jeux vidéo, il combine
          un processeur AMD Ryzen 5 3500X et une carte graphique NVIDIA GeForce RTX 5050 8GB
          pour des performances de haut niveau.
        </p>
        <div class="price">
          <span class="old-price">6,349.00 MAD</span><br>
          <span class="last-price">5,149.00 MAD</span>
        </div>
        <?php if ($added): ?>
