...
<head>
  ...
  <title>Produit GPU - BuyEase</title>
...
<body>
  ...
  <main class="container">
    <div class="custom-card">
      <div class="card-img">
        <img src="../img/MSI-GeForce-RTX-5070-12G-SHADOW-2X-OC-Setup-Game.jpg.webp" alt="GPU MSI GeForce RTX 5070">
      </div>
      <div class="info">
        <h4>BuyEase</h4>
        <h3>MSI GeForce RTX 5070 12G SHADOW 2X OC</h3>
        <p>
          MSI GeForce RTX 5070 12G SHADOW 2X OC incarne le parfait équilibre entre puissance,
          vitesse et prix accessible. Pensé pour les passionnés de jeux vidéo.
        </p>
        <div class="price">
          <span class="old-price">8,349.00 MAD</span><br>
          <span class="last-price">7,149.00 MAD</span>
        </div>
        <?php if ($added): ?>
        ...
        <div class="bo">
          <form action="../Backend/cart.php" method="post" style="display: flex; gap: 10px; width: 100%;">
            <input type="hidden" name="product_name" value="MSI GeForce RTX 5070 12G SHADOW 2X OC">
            <input type="hidden" name="product_price" value="7149">
            <input type="hidden" name="product_image" value="MSI-GeForce-RTX-5070-12G-SHADOW-2X-OC-Setup-Game.jpg.webp">
    ...
    <?php
      $feedbackProductName = 'MSI GeForce RTX 5070 12G SHADOW 2X OC';
      $feedbackRedirect = '../Pages/GPU.php';
